	...
	<div class="col-md-12">
		<div class="widget">
			...
			<div class="widget-body">
				...
				<form action="<?php echo base_url("product/image_upload/$items->id"); ?>" class="dropzone" data-plugin="dropzone" data-options="{ url: '<?php echo base_url("product/image_upload/$items->id"); ?>'}">
