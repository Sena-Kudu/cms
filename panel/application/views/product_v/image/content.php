	...
	<div class="col-md-12">
		<div class="widget">
			...
			<div class="widget-body">
				...
				<form data-url = "<?php echo base_url("product/refresh_image_list/$items->id"); ?>" action="<?php echo base_url("product/image_upload/$items->id"); ?>" id ="dropzone" class="dropzone" data-plugin="dropzone" data-options="{ url: '<?php echo base_url("product/image_upload/$items->id"); ?>'}">
